...
class ControllerExtensionModuleTvcmsbanners extends Controller {
	...
	public function index() {
    	...
    	$data['status_btntext'] 					= $status['btntext'];
	...
	public function install(){
        ...
        foreach ($languages as $value) {
        	$main['tvcmsbanners_main'][$value['language_id']] =  array('title'=>"Audio-Techinica",'des'=>"Profesional HeadPhone",'short'=>"50% Off On Sale ",'img'=>"catalog/demo_main_img.png",'btntext'=>"Shop Now");
        	$lang[$value['language_id']] =  array('title'=>"Audio-Techinica",'des'=>"Profesional HeadPhone",'short'=>"50% Off On Sale ",'img'=>"catalog/demo_main_img.png",'btntext'=>"Shop Now");
		}
		

   		for ($i=1; $i <=1 ; $i++) { 
   			$main['tvcmsbanners_form'][$i] =array('btncap'=>'ttv-banner-contant-center','language'=>$lang,'title'=>"Audio-Techinica",'des'=>"Profesional HeadPhone",'short'=>"50% Off On Sale ",'img'=>"catalog/demo_main_img.png",'btntext'=>"Shop Now",'tvcmsbanners_img'=>"catalog/themevolty/banners/demo_img_1.jpg",'tvcmsbanners_link'=>"#",'tvcmsbanners_grid'=>"12",'tvcmsbanners_height'=>"400",'tvcmsbanners_width'=>"1630",'tvcmsbanners_status'=>"1",'tvcmsbanners_sort'=>"1");
   		}
