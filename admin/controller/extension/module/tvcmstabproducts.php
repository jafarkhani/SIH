...
class ControllerExtensionModuleTvcmstabproducts extends Controller {
	...
	public function install(){
		...
		$main['tvcmstabproducts_pro_spe']['bannerstatus']  	= 0;
        ...
        foreach ($languages as $value) {
        	$main['tvcmstabproducts_pro_fea']['lang_text'][$value['language_id']] =  array('tabtitle'=>"Featured",'hometitle'=>"Featured product",'homesubtitle'=>"Our Featured product",'homedes'=>"our Featured product",'img'=>"catalog/themevolty/tabproducts/best_seller_offer_img_1.jpg");
        	...
        	$main['tvcmstabproducts_pro_best']['lang_text'][$value['language_id']] =  array('tabtitle'=>"BestSeller",'hometitle'=>"Best Product",'homesubtitle'=>"Our best product",'homedes'=>"our Best Product",'img'=>"catalog/themevolty/tabproducts/main_offer_img_1.jpg");
        	$main['tvcmstabproducts_pro_spe']['lang_text'][$value['language_id']] =  array('tabtitle'=>"special",'hometitle'=>"Special Product",'homesubtitle'=>"Our special product",'homedes'=>"our special Product",'img'=>"catalog/themevolty/tabproducts/main_offer_img_1.jpg");
        	$main['tvcmstabproducts_pro_cus']['lang_text'][$value['language_id']] =  array('maintitle'=>"Most Popular",'subtitle'=>"Our Product",'des'=>"Our product",'img'=>"catalog/themevolty/tabproducts/main_offer_img_1.jpg");
		}
