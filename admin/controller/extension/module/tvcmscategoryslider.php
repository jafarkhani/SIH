...
class ControllerExtensionModuleTvcmscategoryslider extends Controller {
	...
	public function install(){
        ...
        foreach ($languages as $value) {
        	$main['tvcmscategoryslider_main'][$value['language_id']] =  array('tvcmscategoryslider_main_cat'=>"Shop By Category",'lang_id'=>"'".$value['language_id']."'",'tvcmscategoryslider_main_short'=>"Short Description1",'tvcmscategoryslider_main_des'=>"Description",'tvcmscategoryslider_main_img'=>"catalog/themevolty/categoryslider/demo_main_img.jpg");
		}
		...
		$category 	 = $this->model_catalog_tvcmscategoryslider->getCategories();
	 	...
	 	for ($i = 1; $i<=$num_of_data; $i++) {
			...
			SET      	tvcmscategoryslidermain_category_id = "'.$category[$i]['category_id'].'" ,
						tvcmscategoryslidermain_image 		= "catalog/themevolty/categoryslider/demo_img_'.$i.'.jpg",
