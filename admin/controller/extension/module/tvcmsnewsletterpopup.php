...
class ControllerExtensionModuletvcmsnewsletterpopup extends Controller {
	...
	public function install(){
        ...
        foreach ($languages as $value) {
        	$main['tvcmsnewsletterpopup']['lang_text'][$value['language_id']] =  array('title'=>"Subscribe To Our Newsletter",'subtitle'=>"Subscribe to our email newsletter today to receive update on the latest news",'img'=>"catalog/themevolty/newsletter/demo_img.jpg",'bgimg'=>"catalog/themevolty/newsletter/featured_offer_img_1.jpg");
		}
