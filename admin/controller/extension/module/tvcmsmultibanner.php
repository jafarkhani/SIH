...
class ControllerExtensionModuletvcmsmultibanner extends Controller {
	...
	public function install(){
        ...
        foreach ($languages as $value) {
        	...
        	$main['tvcmsmultibanner'][$value['language_id']] = array('tvcmsmultibanner_img_1'=>"catalog/themevolty/multibanner/demo_img_1.jpg",'lang_id'=>"'".$value['language_id']."'",'tvcmsmultibanner_cap_1'=>"#","tvcmsmultibanner_subtitle_1"=>"Latest Camera","tvcmsmultibanner_title_1"=>"handeld Gimeal Stabilizer","tvcmsmultibanner_btncap_1"=>"Shop now","tvcmsmultibanner_align_1"=>"ttv-banner-contant-center",'tvcmsmultibanner_status_1'=>"1",'tvcmsmultibanner_width_1'=>"385",'tvcmsmultibanner_height_1'=>"550",'tvcmsmultibanner_img_2'=>"catalog/themevolty/multibanner/demo_img_2.jpg",'lang_id'=>"'".$value['language_id']."'",'tvcmsmultibanner_cap_2'=>"#",'tvcmsmultibanner_status_2'=>"1","tvcmsmultibanner_subtitle_2"=>"Lily Follows You.","tvcmsmultibanner_title_2"=>"Selectable 4k/1080p stabilized","tvcmsmultibanner_btncap_2"=>"Shop now","tvcmsmultibanner_align_2"=>"ttv-banner-contant-center",'tvcmsmultibanner_width_2'=>"385",'tvcmsmultibanner_height_2'=>"550",
        		'tvcmsmultibanner_img_3'=>"catalog/themevolty/multibanner/demo_img_3.jpg",'lang_id'=>"'".$value['language_id']."'",'tvcmsmultibanner_cap_3'=>"#",'tvcmsmultibanner_status_3'=>"1","tvcmsmultibanner_subtitle_3"=>"Oneplus 6","tvcmsmultibanner_title_3"=>"Smart android Mobile","tvcmsmultibanner_btncap_3"=>"Shop now","tvcmsmultibanner_align_3"=>"ttv-banner-contant-left",'tvcmsmultibanner_width_3'=>"799",'tvcmsmultibanner_height_3'=>"260",'tvcmsmultibanner_img_4'=>"catalog/themevolty/multibanner/demo_img_4.jpg",'lang_id'=>"'".$value['language_id']."'",'tvcmsmultibanner_cap_4'=>"#",'tvcmsmultibanner_status_4'=>"1","tvcmsmultibanner_subtitle_4"=>"Sony Bluetooth","tvcmsmultibanner_title_4"=>"Sterero Bluetooth Headset","tvcmsmultibanner_btncap_4"=>"Shop now","tvcmsmultibanner_align_4"=>"ttv-banner-contant-left",'tvcmsmultibanner_width_4'=>"799",'tvcmsmultibanner_height_4'=>"260");
		}
