...
class ControllerExtensionModuletvcmscustomsetting extends Controller {
	...
	public function install(){
        ...
        $main['tvcmscustomsetting_configuration']['comparedisplay'] 		= 0;
        $main['tvcmscustomsetting_configuration']['wishlistdisplay'] 		= 0;
		...
		$main['tvcmscustomsetting_brand_mainimg_width'] 				= 120;
		$main['tvcmscustomsetting_brand_mainimg_height'] 				= 60;
		$main['tvcmscustomsetting_brand_img_width'] 				= 130;
		$main['tvcmscustomsetting_brand_img_height'] 				= 90;
		$main['tvcmscustomsetting_bestproduct_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_bestproduct_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_tvcmsbloggallhome_img_width'] 				= 523;
		$main['tvcmscustomsetting_tvcmsbloggallhome_img_height'] 				= 339;
		$main['tvcmscustomsetting_tvcmsbloggallall_img_width'] 				= 770;
		$main['tvcmscustomsetting_tvcmsbloggallall_img_height'] 				= 564;
		$main['tvcmscustomsetting_tvcmsbloggallsin_img_width'] 				= 770;
		$main['tvcmscustomsetting_tvcmsbloggallsin_img_height'] 				= 564;
		$main['tvcmscustomsetting_tvcmsblogfeahome_img_width'] 				= 523;
		$main['tvcmscustomsetting_tvcmsblogfeahome_img_height'] 				= 339;
		$main['tvcmscustomsetting_tvcmsblogfeaall_img_width'] 				= 770;
		$main['tvcmscustomsetting_tvcmsblogfeaall_img_height'] 				= 564;
		$main['tvcmscustomsetting_tvcmsblogfeasin_img_width'] 				= 770;
		$main['tvcmscustomsetting_tvcmsblogfeasin_img_height'] 				= 564;
		$main['tvcmscustomsetting_categoryslider_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_categoryslider_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_categoryslider_img_width'] 				= 302;
		$main['tvcmscustomsetting_categoryslider_img_height'] 				= 302;
		...
		$main['tvcmscustomsetting_footerlogo_img_width'] 				= 169;
		$main['tvcmscustomsetting_footerlogo_img_height'] 				= 54;
		...
		$main['tvcmscustomsetting_tvcmsnewsletterpoimg_img_width'] 				= 800;
		$main['tvcmscustomsetting_tvcmsnewsletterpoimg_img_height'] 				= 225;
		$main['tvcmscustomsetting_tvcmsnewsletterpobgimg_img_width'] 				= 800;
		$main['tvcmscustomsetting_tvcmsnewsletterpobgimg_img_height'] 				= 444;
		$main['tvcmscustomsetting_leftbanner_img_width'] 				= 322;
		$main['tvcmscustomsetting_leftbanner_img_height'] 				= 523;
		$main['tvcmscustomsetting_leftproduct_img_width'] 				= 345;
		$main['tvcmscustomsetting_leftproduct_img_height'] 				= 380;
		$main['tvcmscustomsetting_lefttestimonial_img_width'] 				= 100;
		$main['tvcmscustomsetting_lefttestimonial_img_height'] 				= 100;
		$main['tvcmscustomsetting_offerbanner_img_width'] 				= 200;
		$main['tvcmscustomsetting_offerbanner_img_height'] 				= 200;
		...
		$main['tvcmscustomsetting_payment_img_height'] 				= 40;
		$main['tvcmscustomsetting_tvcmsproductgridimg_img_width'] 				= 800;
		$main['tvcmscustomsetting_tvcmsproductgridimg_img_height'] 				= 881;
		$main['tvcmscustomsetting_social_img_width'] 				= 200;
		$main['tvcmscustomsetting_social_img_height'] 				= 200;
		$main['tvcmscustomsetting_specialproduct_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_specialproduct_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_special_img_width'] 				= 302;
		$main['tvcmscustomsetting_special_img_height'] 				= 302;
		$main['tvcmscustomsetting_sliderimage_img_width'] 				= 1920;
		$main['tvcmscustomsetting_sliderimage_img_height'] 				= 800;
		$main['tvcmscustomsetting_tvcmssingleblock_img_width'] 				= 1071;
		$main['tvcmscustomsetting_tvcmssingleblock_img_height'] 				= 492;
		$main['tvcmscustomsetting_tabproduct_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_tabproduct_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_tabproduct_img_width'] 				= 302;
		$main['tvcmscustomsetting_tabproduct_img_height'] 				= 302;
		$main['tvcmscustomsetting_testimonial_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_testimonial_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_testimonial_img_width'] 				= 170;
		$main['tvcmscustomsetting_testimonial_img_height'] 				= 170;
        ...
        foreach ($languages as $value) {
        	...
        	$main['tvcmscustomsetting_customsub']['lang_text'][$value['language_id']] =  array('text'=>"© 2019 - Ecommerce software by Opencart™",'link'=>"#",'nopro'=>"10",'newslettertitle'=>"Get Started With Store","newslettersubtitle"=>"Need update so subscribe your email",'customtextstatus'=>"1",'customtext'=>"Hello dear visitor! Glad to see you in our store. Good luck with shopping");
