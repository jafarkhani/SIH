	 	...
	 	for ($i = 1; $i<=$num_of_data; $i++) {
	        ...
	        foreach ($languages as $value) {
				...
				SET 
							...
							tvcmsimageslidersub_des_main		= "MacBook Pro",
							tvcmsimageslidersub_des_sub			= "wi-fi and Bluetooth 4.2 wireless technologies",
							tvcmsimageslidersub_image 			= "catalog/themevolty/slider/demo_img_'.$i.'.jpg",
							tvcmsimageslidersub_title 			= "802.11ac",
							tvcmsimageslidersub_textaligment 	= "ttvmain-slider-contant-none",
							tvcmsimageslidersub_buttoncaption 	= "learn more",
