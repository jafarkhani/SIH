...
class ControllerExtensionModuleTvcmscustomerservices extends Controller {
	...
	public function install(){
        ...
        foreach ($languages as $value) {
        	...
        	$main['tvcmscustomerservices'][$value['language_id']] = array('tvcmscustomerservices_img_1'=>"catalog/themevolty/customerservices/demo_img_1.png",'lang_id'=>"'".$value['language_id']."'",'tvcmscustomerservices_cap_1'=>"Free Shipping Worldwide",'tvcmscustomerservices_des_1'=>"And free returns. See delivery dates.",'tvcmscustomerservices_status_1'=>"1",'tvcmscustomerservices_img_2'=>"catalog/themevolty/customerservices/demo_img_2.png",'lang_id'=>"'".$value['language_id']."'",'tvcmscustomerservices_cap_2'=>"24/7 Customer Suport",'tvcmscustomerservices_des_2'=>"Have a question? Call a or chat online.",'tvcmscustomerservices_status_2'=>"1",'tvcmscustomerservices_img_3'=>"catalog/themevolty/customerservices/demo_img_3.png",'lang_id'=>"'".$value['language_id']."'",'tvcmscustomerservices_cap_3'=>"Money Back Guarantee",'tvcmscustomerservices_des_3'=>"Pay with the world’s and secure payment methods.",'tvcmscustomerservices_status_3'=>"1",'tvcmscustomerservices_img_4'=>"catalog/themevolty/customerservices/demo_img_4.png",'lang_id'=>"'".$value['language_id']."'",'tvcmscustomerservices_cap_4'=>"Shop With Confidence",'tvcmscustomerservices_des_4'=>"Our Buyer Protection  purchasefrom click to delivery.",'tvcmscustomerservices_status_4'=>"1",'tvcmscustomerservices_img_5'=>"catalog/themevolty/customerservices/demo_img_5.png",'lang_id'=>"'".$value['language_id']."'",'tvcmscustomerservices_cap_5'=>"90 Days Return",'tvcmscustomerservices_des_5'=>"Passage Of Lorem Ipsum To Be Embarrassing",'tvcmscustomerservices_status_5'=>"1");
		}
