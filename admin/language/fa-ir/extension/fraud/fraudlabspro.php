...
$_['text_free_email']            = 'رایانامه رایگان';
...
$_['help_ip_latitude']           = 'برآورد عرض جغرافیایی از آی پی آدرس.';
$_['help_ip_longitude']          = 'برآورد طول جغرافیایی از آی پی آدرس.';
$_['help_risk_country']          = 'Whether IP address or billing address country is in the latest high risk list.';
$_['help_free_email']            = 'آیا رایانامه از یک ارائه دهنده رایگان می باشد.';
$_['help_ship_forward']          = 'آیا آدرس حمل و نقل در پایگاه داده از رایانامه شناخته شده می باشد.';
...
// Error
$_['error_permission']           = 'هشدار: شما اجازه ویرایش تنظیمات FraudLabs Pro را ندارید!';
