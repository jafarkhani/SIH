...
class ControllerAccountReturn extends Controller {
	...
	public function info() {
		...
		if ($return_info) {
			...
			$data['date_ordered'] = ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($return_info['date_ordered'])) : date($this->language->get('date_format_short'), strtotime($return_info['date_ordered']));
			$data['date_added'] = ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($return_info['date_added'])) : date($this->language->get('date_format_short'), strtotime($return_info['date_added']));
