...
class ControllerAccountRecurring extends Controller {
	...
	public function info() {
		...
		if ($recurring_info) {
			...
			$data['date_added'] = ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($recurring_info['date_added'])) : date($this->language->get('date_format_short'), strtotime($recurring_info['date_added']));
