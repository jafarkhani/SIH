...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['date_available'])) {
			...
			$data['date_available'] = ($product_info['date_available'] != '0000-00-00') ? (($this->language->get('code') == 'fa') ? gtj($product_info['date_available']) : $product_info['date_available']) : '';
		} else {
			$data['date_available'] = ($this->language->get('code') == 'fa') ? jdate('Y-m-d') : date('Y-m-d');
		}
		...
		foreach ($product_discounts as $product_discount) {
			$data['product_discounts'][] = array(
				...
				'date_start'        => ($product_discount['date_start'] != '0000-00-00') ? (($this->language->get('code') == 'fa') ? gtj($product_discount['date_start']) : $product_discount['date_start']) : '',
				'date_end'          => ($product_discount['date_end'] != '0000-00-00') ? (($this->language->get('code') == 'fa') ? gtj($product_discount['date_end']) : $product_discount['date_end']) : ''
			);
		}
		...
		foreach ($product_specials as $product_special) {
			$data['product_specials'][] = array(
				...
				'date_start'        => ($product_special['date_start'] != '0000-00-00') ? (($this->language->get('code') == 'fa') ? gtj($product_special['date_start']) : $product_special['date_start']) : '',
				'date_end'          => ($product_special['date_end'] != '0000-00-00') ? (($this->language->get('code') == 'fa') ? gtj($product_special['date_end']) : $product_special['date_end']) :  ''
			);
		}
		...
		if (isset($this->request->post['autoassign'])) {
