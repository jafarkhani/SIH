		...
		if (isset($this->request->get['api_id'])) {
			...
			foreach ($results as $result) {
				$data['api_sessions'][] = array(
					...
					'ip'             => $result['ip'],
					'date_added'     => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($result['date_added'])) : date($this->language->get('datetime_format'), strtotime($result['date_added'])),
					'date_modified'  => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($result['date_modified'])) : date($this->language->get('datetime_format'), strtotime($result['date_modified']))
				);
			}
		}
