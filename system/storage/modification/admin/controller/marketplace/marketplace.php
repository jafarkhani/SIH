...
class ControllerMarketplaceMarketplace extends Controller {
	...
	public function info() {
        ...
        $data['error_signature'] = '';
			...
			$data['date_added'] = ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($response_info['date_added'])) : date($this->language->get('date_format_short'), strtotime($response_info['date_added']));
			$data['date_modified'] = ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($response_info['date_modified'])) : date($this->language->get('date_format_short'), strtotime($response_info['date_modified']));
