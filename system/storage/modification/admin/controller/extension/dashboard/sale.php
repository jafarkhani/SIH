...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function dashboard() {
		...
		$today = $this->model_extension_dashboard_sale->getTotalSales(array('filter_date_added' => ($this->language->get('code') == 'fa') ? jdate('Y-m-d', strtotime('-1 day')) : date('Y-m-d', strtotime('-1 day'))));

		$yesterday = $this->model_extension_dashboard_sale->getTotalSales(array('filter_date_added' => ($this->language->get('code') == 'fa') ? jdate('Y-m-d', strtotime('-2 day')) : date('Y-m-d', strtotime('-2 day'))));
