...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'date_modified' => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($result['date_modified'])) : date($this->language->get('date_format_short'), strtotime($result['date_modified'])),
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['date_added'] = ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($order_info['date_added'])) : date($this->language->get('date_format_short'), strtotime($order_info['date_added']));
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$data['orders'][] = array(
					...
					'date_added'       => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($order_info['date_added'])) : date($this->language->get('date_format_short'), strtotime($order_info['date_added'])),
