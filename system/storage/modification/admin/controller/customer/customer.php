	...
	public function ip() {
		...
		foreach ($results as $result) {
			$data['ips'][] = array(
				...
				'date_added' => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_khorshididate_format'), strtotime($result['date_added'])) : date('d/m/y', strtotime($result['date_added'])),
